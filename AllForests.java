...
public class AllForests{
   static public int minNodes=17; // minNodes is the minimum number of nodes in the forest
   static public int n=17; // n is the maximum number of nodes in the forest
